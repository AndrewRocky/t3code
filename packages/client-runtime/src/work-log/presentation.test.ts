...
describe("workLogEntryIsLocalCodeSearch", () => {
  ...
  // `web_search`, and `deriveToolActivityPresentation` has already replaced the
  // agent's own title with the generic summary. The classifier itself is
  // module-private, so these assert it through the two exported callers.
