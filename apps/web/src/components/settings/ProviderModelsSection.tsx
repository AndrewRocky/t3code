...
const CUSTOM_MODEL_PLACEHOLDER_BY_KIND: Partial<Record<ProviderDriverKind, string>> = {
  ...
  // Hermes model ids are `<provider>:<model>`; the placeholder is the only
  // hint a user gets that the provider prefix is required.
  [ProviderDriverKind.make("hermes")]: "openrouter:z-ai/glm-5.2",
