...
let currentModeId = hermesMode ? "default" : "ask";
...
const availableModes: ReadonlyArray<AcpSchema.SessionMode> = hermesMode
...
function modelState(): AcpSchema.SessionModelState {
  const fallbackModelId = hermesMode ? "openrouter:z-ai/glm-5.2" : "grok-build";
